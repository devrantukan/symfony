...
abstract class BaseGuest extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Festival\\GuestBundle\\Model\\GuestPeer';
     ...
     * @return Guest The current object (for fluent API support)
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = GuestPeer::NAME;
        }
    ...
    public function setSurname($v)
    {
        ...
        if ($this->surname !== $v) {
            $this->surname = $v;
            $this->modifiedColumns[] = GuestPeer::SURNAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = GuestPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GuestPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GuestPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GuestPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(GuestPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }
        if ($this->isColumnModified(GuestPeer::SURNAME)) {
            $modifiedColumns[':p' . $index++]  = '`SURNAME`';
        }

        $sql = sprintf(
            'INSERT INTO `guest` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Guest'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Guest'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GuestPeer::NAME)) $criteria->add(GuestPeer::NAME, $this->name);
        if ($this->isColumnModified(GuestPeer::SURNAME)) $criteria->add(GuestPeer::SURNAME, $this->surname);
     ...
     * objects.
     *
     * @param object $copyObj An object of Guest (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Guest Clone of current object.
     * @throws PropelException
     */
