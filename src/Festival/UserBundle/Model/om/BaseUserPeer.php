...
namespace Festival\UserBundle\Model\om;
...
use Festival\UserBundle\Model\UserPeer;
use Festival\UserBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Festival\\UserBundle\\Model\\User';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::NAME, UserPeer::SURNAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::NAME => 1, UserPeer::SURNAME => 2, ),
