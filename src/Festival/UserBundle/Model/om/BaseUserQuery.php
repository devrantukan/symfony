...
use Festival\UserBundle\Model\UserQuery;
...
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Festival\\UserBundle\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `surname` FROM `user` WHERE `id` = :p0';
        try {
