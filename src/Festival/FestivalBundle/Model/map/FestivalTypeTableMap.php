...
/**
 * This class defines the structure of the 'festival_type' table.
 *
 *
 *
 ...
 */
class FestivalTypeTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Festival.FestivalBundle.Model.map.FestivalTypeTableMap';
    ...
    {
        // attributes
        $this->setName('festival_type');
        $this->setPhpName('FestivalType');
        $this->setClassname('Festival\\FestivalBundle\\Model\\FestivalType');
