...
abstract class BaseFestivalType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Festival\\FestivalBundle\\Model\\FestivalTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FestivalTypePeer
     */
     ...
     * @return FestivalType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FestivalTypePeer::ID;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = FestivalTypePeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = FestivalTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FestivalType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FestivalTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FestivalTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FestivalTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FestivalTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(FestivalTypePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPTION`';
        }

        $sql = sprintf(
            'INSERT INTO `festival_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FestivalTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FestivalTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FestivalType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FestivalType'][$this->getPrimaryKey()] = true;
        $keys = FestivalTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FestivalTypePeer::ID)) $criteria->add(FestivalTypePeer::ID, $this->id);
        if ($this->isColumnModified(FestivalTypePeer::DESCRIPTION)) $criteria->add(FestivalTypePeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(FestivalTypePeer::DATABASE_NAME);
        $criteria->add(FestivalTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of FestivalType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FestivalType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FestivalTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FestivalTypePeer();
        }
     ...
     * If this FestivalType is new, it will return
    ...
    public function setFestivals(PropelCollection $festivals, PropelPDO $con = null)
    {
        ...
        foreach ($this->festivalsScheduledForDeletion as $festivalRemoved) {
            $festivalRemoved->setFestivalType(null);
        }
     ...
     * Otherwise if this FestivalType is new, it will return
     * an empty collection; or if this FestivalType has previously
     * been saved, it will retrieve related Festivals from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FestivalType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(FestivalTypePeer::DEFAULT_STRING_FORMAT);
    }
