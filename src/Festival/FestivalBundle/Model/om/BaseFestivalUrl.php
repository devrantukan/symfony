...
abstract class BaseFestivalUrl extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Festival\\FestivalBundle\\Model\\FestivalUrlPeer';
    ...
    /**
     * The value for the festival_url_type_id field.
     * @var        int
     */
    protected $festival_url_type_id;
    ...
    /**
     * Get the [festival_url_type_id] column value.
     *
     * @return int
     */
    public function getFestivalUrlTypeId()
    {
        return $this->festival_url_type_id;
    }
     ...
     * @return FestivalUrl The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FestivalUrlPeer::ID;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = FestivalUrlPeer::URL;
        }
    ...
    /**
     * Set the value of [festival_url_type_id] column.
     *
     * @param int $v new value
     * @return FestivalUrl The current object (for fluent API support)
     */
    public function setFestivalUrlTypeId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->festival_url_type_id !== $v) {
            $this->festival_url_type_id = $v;
            $this->modifiedColumns[] = FestivalUrlPeer::FESTIVAL_URL_TYPE_ID;
        }

        if ($this->aFestivalUrlType !== null && $this->aFestivalUrlType->getId() !== $v) {
            $this->aFestivalUrlType = null;
        }


        return $this;
    } // setFestivalUrlTypeId()
    ...
    public function setFestivalId($v)
    {
        ...
        if ($this->festival_id !== $v) {
            $this->festival_id = $v;
            $this->modifiedColumns[] = FestivalUrlPeer::FESTIVAL_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->festival_url_type_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->festival_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = FestivalUrlPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FestivalUrl object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aFestivalUrlType !== null && $this->festival_url_type_id !== $this->aFestivalUrlType->getId()) {
            $this->aFestivalUrlType = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FestivalUrlPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FestivalUrlQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FestivalUrlPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aFestivalUrlType !== null) {
                if ($this->aFestivalUrlType->isModified() || $this->aFestivalUrlType->isNew()) {
                    $affectedRows += $this->aFestivalUrlType->save($con);
                }
                $this->setFestivalUrlType($this->aFestivalUrlType);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FestivalUrlPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(FestivalUrlPeer::URL)) {
            $modifiedColumns[':p' . $index++]  = '`url`';
        }
        if ($this->isColumnModified(FestivalUrlPeer::FESTIVAL_URL_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`festival_url_type_id`';
        }
        if ($this->isColumnModified(FestivalUrlPeer::FESTIVAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`festival_id`';
        }

        $sql = sprintf(
            'INSERT INTO `festival_url` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`url`':
                        ...
                        break;
                    case '`festival_url_type_id`':
                        $stmt->bindValue($identifier, $this->festival_url_type_id, PDO::PARAM_INT);
                        break;
                    case '`festival_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aFestivalUrlType !== null) {
                if (!$this->aFestivalUrlType->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aFestivalUrlType->getValidationFailures());
                }
            }


            if (($retval = FestivalUrlPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FestivalUrlPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getFestivalUrlTypeId();
                break;
            case 3:
    ...
    {
        if (isset($alreadyDumpedObjects['FestivalUrl'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FestivalUrl'][$this->getPrimaryKey()] = true;
        $keys = FestivalUrlPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUrl(),
            $keys[2] => $this->getFestivalUrlTypeId(),
            $keys[3] => $this->getFestivalId(),
        );
        if ($includeForeignObjects) {
            if (null !== $this->aFestivalUrlType) {
                $result['FestivalUrlType'] = $this->aFestivalUrlType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setFestivalUrlTypeId($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setFestivalUrlTypeId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setFestivalId($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FestivalUrlPeer::ID)) $criteria->add(FestivalUrlPeer::ID, $this->id);
        if ($this->isColumnModified(FestivalUrlPeer::URL)) $criteria->add(FestivalUrlPeer::URL, $this->url);
        if ($this->isColumnModified(FestivalUrlPeer::FESTIVAL_URL_TYPE_ID)) $criteria->add(FestivalUrlPeer::FESTIVAL_URL_TYPE_ID, $this->festival_url_type_id);
        if ($this->isColumnModified(FestivalUrlPeer::FESTIVAL_ID)) $criteria->add(FestivalUrlPeer::FESTIVAL_ID, $this->festival_id);
    ...
    {
        $criteria = new Criteria(FestivalUrlPeer::DATABASE_NAME);
        $criteria->add(FestivalUrlPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of FestivalUrl (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setFestivalUrlTypeId($this->getFestivalUrlTypeId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FestivalUrl Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FestivalUrlPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FestivalUrlPeer();
        }
    ...
    /**
     * Declares an association between this object and a FestivalUrlType object.
     *
     * @param             FestivalUrlType $v
     * @return FestivalUrl The current object (for fluent API support)
     * @throws PropelException
     */
    public function setFestivalUrlType(FestivalUrlType $v = null)
    {
        if ($v === null) {
            $this->setFestivalUrlTypeId(NULL);
        } else {
            $this->setFestivalUrlTypeId($v->getId());
        }

        $this->aFestivalUrlType = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the FestivalUrlType object, it will not be re-added.
        if ($v !== null) {
            $v->addFestivalUrl($this);
        }
    ...
    /**
     * Get the associated FestivalUrlType object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return FestivalUrlType The associated FestivalUrlType object.
     * @throws PropelException
     */
    public function getFestivalUrlType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFestivalUrlType === null && ($this->festival_url_type_id !== null) && $doQuery) {
            $this->aFestivalUrlType = FestivalUrlTypeQuery::create()->findPk($this->festival_url_type_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFestivalUrlType->addFestivalUrls($this);
             */
        }

        return $this->aFestivalUrlType;
    }
     ...
     * If this FestivalUrl is new, it will return
    ...
    public function setFestivals(PropelCollection $festivals, PropelPDO $con = null)
    {
        ...
        foreach ($festivalsToDelete as $festivalRemoved) {
            $festivalRemoved->setFestivalUrl(null);
        }
     ...
     * Otherwise if this FestivalUrl is new, it will return
     * an empty collection; or if this FestivalUrl has previously
     * been saved, it will retrieve related Festivals from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FestivalUrl.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function clear()
    {
        $this->id = null;
        $this->url = null;
        $this->festival_url_type_id = null;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aFestivalUrlType instanceof Persistent) {
              $this->aFestivalUrlType->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(FestivalUrlPeer::DEFAULT_STRING_FORMAT);
    }
